            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
              ...
              <li className="nav-item dropdown  ">
                ...
                <ul className="dropdown-menu " aria-labelledby="navbarDropdown">
                  <li>
                    <Link className="dropdown-item " to="/gallery/res">
                      Res
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item " to="/gallery/cerdo">
                      Cerdo
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to="/gallery/pollo">
                      Pollo
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to="gallery/pescado">
                      Pescado
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to="/gallery/queso">
                      Quesos
                    </Link>
                  </li>
                </ul>
          ...
          >
            <div className="d-flex">
              <img
                ...
                alt=""
              />
              <h6 className="text-white">{totalItems}</h6>
            </div>
          </button>
